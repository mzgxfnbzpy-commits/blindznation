...
// ── Sept 2026 book, transcribed ────────────────────────────────────────────
// The CP_PRICE table below is NOT from any book: the rows are clean arithmetic
// ladders and every value runs 3-4x under Norman list (36x24 reads 148 where the
// book reads 404 or 492). The page is therefore quote-only (see
// PB_QUOTE_ONLY_PAGES in shared.js) until the tables below can be switched on.
//
...
var CP_BOOK_G1 = {   // Price Group 1 — Scarlett (404 at 36x24)
  ...
  54:[574,743,824,916,1014,1074,1113,1154,1220,1532,1803],
  60:[627,824,861,1003,1052,1130,1147,1215,1269,1659,2098],
  66:[655,858,951,1042,1106,1173,1204,1264,1321,1854,2166],
  72:[740,923,1014,1094,1154,1230,1254,1317,1419,1962,2306],
  78:[793,965,1080,1151,1224,1290,1316,1399,1582,2034,2390],
...
var CP_BOOK_G3 = {   // Price Group 3 — Blake, Libeco, Rochelle, Bali, Breeze, Ellie (593)
  ...
  54:[824,1085,1198,1338,1467,1564,1617,1740,1809,2062,2624],
  60:[913,1198,1251,1459,1526,1643,1727,1848,1987,2199,3046],
  66:[971,1239,1382,1518,1602,1705,1819,2040,2190,2376,3151],
  72:[1055,1341,1467,1590,1685,1793,1991,2222,2385,2607,3353],
  78:[1157,1406,1568,1676,1778,1962,2166,2452,2595,2806,3476],
