...
function buildCartItem() {
  ...
  const brandLabel  = currentBrand === 'norman' ? 'Norman'
                    : currentBrand === 'pb'     ? 'Blindznation Custom'
                    : 'Other';
...
function pbCalcPrice() {
  ...
  // the June rename and that old label is still accepted, so a stale cached page
  // keeps pricing instead of silently going blank.
...
function rnUpdatePrice() {
  ...
  // Motor stays out of the discount base — motorization is always full retail.
